...
export const en: Translations = {
    ...
    canvas: {
        ...
        export: 'Share',
        exportAsPng: 'Download PNG',
        exportAsJpg: 'Download JPG',
        exportAsWebp: 'Download WEBP',
        exportAsPdf: 'Download PDF',
        ...
        exportPreviewFailed: 'Preview not available yet. Try changing export options.',
        exportEmpty: 'Your board is empty. Add content first.',
        exportFailed: 'Export failed. Please try again.',
        exportSuccessPng: 'PNG downloaded.',
        exportSuccessJpg: 'JPG downloaded.',
        exportSuccessWebp: 'WEBP downloaded.',
        exportSuccessPdf: 'PDF downloaded.',
        exportUpgrade: 'Export is available on Plus and above.',
        select: 'Select',
        hand: 'Hand',
        pen: 'Pen',
        eraser: 'Eraser',
