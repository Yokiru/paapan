            ...
            >
                <form onSubmit={handleLogin} className="w-full">
                    ...
                    <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-center">
                        <p className="text-sm font-medium text-slate-700">Masuk dengan Google segera hadir</p>
                        <p className="mt-1 text-xs text-slate-500">Untuk saat ini, silakan masuk dengan email dan password terlebih dahulu.</p>
                    </div>
                </form>
            </AuthLayout>
        </>
